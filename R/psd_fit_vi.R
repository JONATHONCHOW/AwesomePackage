...
#' \item{\code{Loss}}{A vector represents the value of the loss function which records once for ten iterations.}
...
#' psd_fit_vi(G, 2, 1e-1, 10)
psd_fit_vi <- function (G, K, epsilon = 1e-1, maxiter = 500)
{
  I <- nrow(G)
  J <- ncol(G)
  # Init.
