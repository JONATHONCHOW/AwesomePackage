...
```{r}
plot_structure(result_HGDP_svi_K7_full_million$P, pops = c(7,4,5,3,6,1,2), label = label, map.indiv = indiv, map.pop = spop, gap = 3, font.size = 5, title = "Data Set: HGDP (full) | Method: SVI (1e+6 interations) | K: 7")
```
