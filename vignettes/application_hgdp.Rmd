...
&emsp;&emsp;We store the result as `result_HGDP_full.RData`.
...
In addition, we iterated for a million times for the case of `K` equals 7 to get `result_HGDP_svi_K7_full_million`, and made a structure diagram similar to the way in the article [@raj2014faststructure], and the results were almost the same.

```{r fig.height=3, fig.width=9, fig.show='hold'}
plot_structure(result_HGDP_svi_K7_full_million$P, pops = c(7,4,5,3,6,1,2), 
               label = label, map.indiv = indiv, map.pop = spop, gap = 3, font.size = 5, 
